...
class PagePer {
    ...
    public function __construct($param = array('total'=> 0, 'size' => 1, 'page' => 1, 'url'=>'', 'show' => 2)) {
        $this->myde_total = $this->numeric($param['total']);
        $this->myde_size = $this->numeric($param['size']);
        $this->myde_page = $this->numeric($param['page']);
        $this->myde_page_count = ceil($this->myde_total / $this->myde_size);
        $this->myde_url = $param['url'];
        ...
        $this->myde_i = $this->myde_page - $param['show'];
        $this->myde_en = $this->myde_page + $param['show'];
        if ($this->myde_i < 1) {
